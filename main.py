...
letter10 = input("Select letter : ")
print(letter10)
letter20 = input("Select letter : ")
print(letter20)
letter30 = input("Select letter : ")
print(letter30)

my_list = []
my_list.append(letter10)
my_list.append(letter20)
my_list.append(letter30)

letter1 = len(letter10)
print(letter1)

letter2 = len(letter20)
print(letter20)

letter3 = len(letter30)
print(letter3)
...
# print("There are " + str(var1) + " letter in the paragraph.")

# 3. What are the first and last letters of the text? Here, we will clearly use indexing.

# 4. The system will show us how the te would look like if we inverted the order of the words. Is there any method that allows us to invert the order of a list? And another one that allows us to join these elements with spaces in between?
